...
public:
    ...
    explicit MessageBox(QWidget *parent = 0, bool isYes = true, bool isNo = true, bool isCancel = true, bool isCheckBox = true, QString title = NULL, QString text = NULL, int msgType = 0, QString checkText = NULL);
